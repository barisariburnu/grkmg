...
import { ConfigDrawer } from '@workspace/ui/components/config-drawer';
import { Header } from '@workspace/ui/components/layout/header';
import { Main } from '@workspace/ui/components/layout/main';
import { NewChat } from '@workspace/ui/components/new-chat';
import { ProfileDropdown } from '@workspace/ui/components/profile-dropdown';
import { Search } from '@workspace/ui/components/search';
import { ThemeSwitch } from '@workspace/ui/components/theme-switcher';
import {
  Avatar,
  AvatarFallback,
  AvatarImage,
